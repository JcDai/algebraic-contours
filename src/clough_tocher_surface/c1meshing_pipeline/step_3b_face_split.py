...
def face_split(workspace_path, tet_after_para_vertices, tet_after_para_tets, parametrized_file, para_out_v_to_tet_v_map, surface_adj_tet_para_out, winding_numbers):
    # print(para_out_v_to_tet_v_map)
    # check orientation
    vv = tet_after_para_vertices
    tt = tet_after_para_tets
    ...
    para_out_v, para_out_tc, _, para_out_f, para_out_ftc, _ = igl.read_obj(
        workspace_path + parametrized_file
    )
    ...
    tet_after_face_split_vertices = copy.deepcopy(
        tet_after_para_vertices.tolist())
