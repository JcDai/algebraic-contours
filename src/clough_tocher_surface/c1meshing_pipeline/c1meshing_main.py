...
if __name__ == "__main__":
    ...
    parametrization_free_cones(
        workspace_path,
        path_to_para_exe,
        cone_file="embedded_surface_Th_hat_new",
        field_file="embedded_surface_kappa_hat",
        meshfile="embedded_surface.obj",
    )

    # compute_cone_vids(workspace_path)
    compute_cone_vids(workspace_path, cone_file="embedded_surface_Th_hat_new")

    parametrization_split(
        workspace_path,
        tets_vertices_regular,
        tets_regular,
        surface_adj_tet,
        para_in_v_to_tet_v_map,
        path_to_toolkit_para_exe,
        meshfile_before_para="embedded_surface.obj",
        meshfile_after_para="parameterized_mesh.obj",
    )
    ...
    cone_split_once_only(
        workspace_path,
        path_to_toolkit_cone_exe,
        "toolkit_para_split_tetmesh_tets.vtu",
        "surface_uv_after_para_split.obj",
        "cone_vids_after_para_split.txt",
        "surface_tet_local_face_map_after_para_split.txt",
        "surface_adj_tet_after_para_split.txt",
        "surface_v_to_tet_v_after_para_split.txt",
    )
    ...
    (
        ...
        workspace_path,
        "toolkit_cone_split_tetmesh_tets.vtu",
    ...
    interpolate_initial_solution(
        output_name,
        "CT/laplace_beltrami_mesh.msh",
        "degenerate_special.msh",
        output_name + "_initial_tetmesh.msh",
        initial_guess_weight,
        output_name + "_tri_to_tet_v_map.txt",
        "CT_lag2bezier_matrix.txt",
    )
    ...
    build_full_expanded_bezier_hard_constraint_matrix(
        workspace_path,
        output_name + "_tri_to_tet_v_map.txt",
        "CT_bezier_constraints_expanded_old.txt",
        output_name + "_initial_tetmesh.msh",
        tet_edge_to_vertices,
        tet_face_to_vertices,
        "CT_bezier_r2f_expanded_old.txt",
        "CT_bezier_r2f_mat_col_idx_map_old.txt",
        output_name + "_interp_initial_mesh.msh",
    )
