...
public:
  ...
  Eigen::Matrix<double, 10, 1> monomial_basis_eval(const double& u,
                                                   const double& v,
  ...
  void triangulate_normalized(size_t num_refinements,
                              std::array<Eigen::MatrixXd, 3>& V,
                              std::array<Eigen::MatrixXi, 3>& F) const;
  ...
  Eigen::Matrix<double, 3, 1> CT_eval_normalized(int idx,
                                                 const double& u,
