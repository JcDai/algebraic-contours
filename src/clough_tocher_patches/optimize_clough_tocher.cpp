...
std::vector<Eigen::Vector3d> CloughTocherOptimizer::optimize_energy(
...
CloughTocherOptimizer::generate_stiffness_matrix() const {
  ...
  for (int fijk = 0; fijk < num_faces; ++fijk) {
    ...
    assemble_local_siffness_matrix(face_chart.face_uv_positions, nodes,
