...
def map_tri_nodes_to_tet_nodes(workspace_path, output_name, face_split_f_to_tet_v_map, para_out_v_to_tet_v_map, tetmesh_file="tetmesh_after_face_split_high_order_tet.msh", ct_nodes_file="CT_from_lagrange_nodes.msh", ct_i2o_v_file="CT_from_lagrange_nodes_input_v_to_output_v_map.txt"):
    ct_interpolants_file = ct_nodes_file
    ct_input_v_to_output_v_file = ct_i2o_v_file
