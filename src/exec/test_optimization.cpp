...
double evaluate_energy(double u[3],double v[3], double test_cp[3][10]) {
  ...
  std::array<std::array<int64_t, 10>, 3> micro_nodes = get_micro_triangle_nodes(affine_manifold, 0);
  ...
  spdlog::info("points are {}, {}, {}", bezier_control_points[0][0], bezier_control_points[1][0], bezier_control_points[2][0]);
